...
beforeEach(async () => {
  ...
  boardMembersMatrixDataPoints = await BoardMembersMatrixDataPoints.create({ createdBy: user, datapointId: 'test', companyId: 'test', boardMemberName: 'test', year: 'test', fiscalYearEndDate: 'test', response: 'test', status: 'test' })
})
